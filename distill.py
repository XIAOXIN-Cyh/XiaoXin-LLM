...
if __name__ == '__main__':
    ...
    parser.add_argument('--wandb_project', type = str, default = "XiaoXin-distill")
    ...
    # max_seq_len 默认为 1024，因为使用的数据是 r1_1024
    # 如果使用 512 的默认值，会对文本截断，导致效果很差
    ...
    # 设置 wandb 运行名称
    args.wandb_run_name = f'XiaoXin-Distill-{args.epochs}-{args.accumulation_steps}-{args.batch_size}-{args.learning_rate}'
